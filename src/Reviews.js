...
const restaurantData = [
  {
    ...
    ratings: [
      ...
      { ratingID: 3, rating: 5, comment: "Great guys, GREAT CHICKEN" },
      {
        ratingID: 4,
        rating: 4,
        comment:
...

  {
    ...
    ratings: [
      ...
      { ratingID: 3, rating: 5, comment: "Great guys, GREAT FISH" },
      { ratingID: 4, rating: 4, comment: "cRAB LINGUINI WAS TO DIE FOR!!!1!" },
    ],
  },

  {
    ...
    rating: 4.5,
    ratings: [
      { ratingID: 1, rating: 4, comment: "God Cress this place" },
      { ratingID: 2, rating: 5, comment: "SWEET! (potato)" },
      {
        ratingID: 3,
        rating: 5,
        comment: "Lettuce eat here every week from now on!",
      },
      { ratingID: 4, rating: 4, comment: "onYUM" },
    ],
  },
...

  {
    ...
    ratings: [
      ...
      { ratingID: 3, rating: 5, comment: "oooooof that pizza is licious" },
      {
        ratingID: 4,
        rating: 4,
